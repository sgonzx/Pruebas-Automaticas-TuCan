  ...
  def ejectuarCP004NChrome(self):
    try:
        ...
        for row in self.reader:
          ...
          print("COMENTAR O HACER SQUAWK DE FORMA FALLIDA CON REGISTRO",row["ID_Reg"],"SE HA EJECUTADO CORRECTAMENTE EN CHROME.")
      
    except:
        print("SE HA DETECTADO UN ERROR EN EL CP004N, SE RECOMIENDA REVISION.")

ejecucion = TestCP004NSquack()
ejecucion.ejectuarCP004NChrome()
