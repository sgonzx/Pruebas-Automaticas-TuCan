...
class TestCP004PSquack():
  ...
  def ejectuarCP004PFirefox(self):
    try:
        ...
        for row in self.reader:
          ...
          print("COMENTAR O HACER SQUAWK CON REGISTRO",row["ID_Reg"],"SE HA EJECUTADO CORRECTAMENTE EN FIREFOX.")
      
    except:
        print("SE HA DETECTADO UN ERROR EN EL CP004P, SE RECOMIENDA REVISION.")

ejecucion = TestCP004PSquack()
ejecucion.ejectuarCP004PFirefox()