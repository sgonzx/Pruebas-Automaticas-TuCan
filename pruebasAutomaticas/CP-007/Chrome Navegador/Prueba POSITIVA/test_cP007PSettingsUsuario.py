  ...
  def ejectuarCP007PChrome(self):
    try:
        ...
        for row in self.reader:
          ...
          print("EDITAR EL USUARIO EN TUCAN CON REGISTRO",row["ID_Reg"],"SE HA EJECUTADO CORRECTAMENTE EN CHROME.")
      
    except:
        print("SE HA DETECTADO UN ERROR EN EL CP007P, SE RECOMIENDA REVISION.")

ejecucion = TestCP007PSettingsUsuario()
ejecucion.ejectuarCP007PChrome()
