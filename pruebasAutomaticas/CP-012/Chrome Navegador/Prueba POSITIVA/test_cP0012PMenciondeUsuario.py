...
class TestCP0012PMenciondeUsuario():
  ...
  def ejectuarCP0012PChrome(self):
    try:
        ...
        for row in self.reader:
          ...
          print("MENCIONAR OTRO USUARIO EN TUCAN CON REGISTRO",row["ID_Reg"],"SE HA EJECUTADO CORRECTAMENTE EN CHROME.")
      
    except:
        print("SE HA DETECTADO UN ERROR EN EL CP0012P, SE RECOMIENDA REVISION.")

ejecucion = TestCP0012PMenciondeUsuario()
ejecucion.ejectuarCP0012PChrome()
