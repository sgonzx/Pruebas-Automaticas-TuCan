...
class TestCP001PRegistrodeUsuario():
  ...
  def ejectuarCP001PFirefox(self):
    try:
      ...
      for row in self.reader:
         ...
         print("EL REGISTRO CON IDENTIFICACION",row["ID_Reg"],"SE HA EJECUTADO CORRECTAMENTE EN FIREFOX.")
        
    except:
      print("SE HA DETECTADO UN ERROR EN EL CP001P, SE RECOMIENDA REVISION.")
      
ejecucion = TestCP001PRegistrodeUsuario()
ejecucion.ejectuarCP001PFirefox()