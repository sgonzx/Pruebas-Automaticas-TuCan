...
class TestCP001NRegistrodeUsuario():
  ...
  def ejectuarCP001NFirefox(self):
    try:
      ...
      for row in self.reader:
         ...
         print("REGISTRO DE USUARIO EN EL SISTEMA SIN TENER EN CUENTA LA CONTRASEÑA", row["ID_Reg"], "SE HA EJECUTADO CORRECTAMENTE EN FIREFOX.")
    
    except:
      print("SE HA DETECTADO UN ERROR EN EL CP001N, SE RECOMIENDA REVISION.")

ejecucion = TestCP001NRegistrodeUsuario()
ejecucion.ejectuarCP001NFirefox()