...
class TestCP0010PComentarunaPublicacion():
  ...
  def ejectuarCP0010PFirefox(self):
    try:
        ...
        for row in self.reader:
          ...
          print("COMENTAR UNA PUBLICACION CON REGISTRO",row["ID_Reg"],"SE HA EJECUTADO CORRECTAMENTE EN FIREFOX.")
      
    except:
        print("SE HA DETECTADO UN ERROR EN EL CP0010P, SE RECOMIENDA REVISION.")

ejecucion = TestCP0010PComentarunaPublicacion()
ejecucion.ejectuarCP0010PFirefox()