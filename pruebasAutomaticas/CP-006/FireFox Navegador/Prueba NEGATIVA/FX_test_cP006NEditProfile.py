...
class TestCP006NEditProfile():
  ...
  def ejectuarCP006NFirefox(self):
    try:
        ...
        for row in self.reader:
          ...
          print("EDITAR EL PERFIL DE FORMA FALLIDA CON REGISTRO",row["ID_Reg"],"SE HA EJECUTADO CORRECTAMENTE EN FIREFOX.")
      
    except:
        print("SE HA DETECTADO UN ERROR EN EL CP006N, SE RECOMIENDA REVISION.")

ejecucion = TestCP006NEditProfile()
ejecucion.ejectuarCP006NFirefox()