  ...
  def ejectuarCP006PChrome(self):
    try:
        ...
        for row in self.reader:
          ...
          print("EDITAR EL PERFIL SATISFACTORIAMENTE CON REGISTRO",row["ID_Reg"],"SE HA EJECUTADO CORRECTAMENTE EN CHROME.")
      
    except:
        print("SE HA DETECTADO UN ERROR EN EL CP006P, SE RECOMIENDA REVISION.")

ejecucion = TestCP006PEditProfile()
ejecucion.ejectuarCP006PChrome()