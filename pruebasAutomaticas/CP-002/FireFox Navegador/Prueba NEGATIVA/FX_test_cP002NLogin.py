...
class TestCP002NLogin():
  ...
  def ejectuarCP002NFirefox(self):
    try:
        ...
        for row in self.reader:
          ...
          print("EL INGRESO AL SISTEMA POR EL USUARIO CON LA CONTRASEÑA ERRONEA CON REGISTRO",row["ID_Reg"],"SE HA EJECUTADO CORRECTAMENTE EN FIREFOX.")
      
    except:
        print("SE HA DETECTADO UN ERROR EN EL CP002N, SE RECOMIENDA REVISION.")

ejecucion = TestCP002NLogin()
ejecucion.ejectuarCP002NFirefox()