...
class TestCP002PLogin():
  ...
  def ejectuarCP002PChromeFirefox(self):
    try:
        ...
        for row in self.reader:
            ...
            print("EL INGRESO AL SISTEMA POR EL USUARIO CON REGISTRO",row["ID_Reg"],"SE HA EJECUTADO CORRECTAMENTE EN FIREFOX.")
      
    except:
        print("SE HA DETECTADO UN ERROR EN EL CP002P, SE RECOMIENDA REVISION.")

ejecucion = TestCP002PLogin()
ejecucion.ejectuarCP002PFirefox()