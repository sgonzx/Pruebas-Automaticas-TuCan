...
class TestCP001NRegistrodeUsuario():
  ...
  def ejectuarCP001NChrome(self):
    try:
      ...
      with open("Libro1.csv") as csvArch:
        ...
        for row in self.reader:
          ...
          print("REGISTRO DE USUARIO EN EL SISTEMA SIN TENER EN CUENTA LA CONTRASEÑA", row["ID_Reg"], "SE HA EJECUTADO CORRECTAMENTE.")
    
    except:
      print("SE HA DETECTADO UN ERROR EN EL CP001P, SE RECOMIENDA REVISION.")

ejecucion = TestCP001NRegistrodeUsuario()
ejecucion.ejectuarCP001NChrome()